...
<br>
<br>
This block diagram was developed with user safety in mind. UART endures fast enough communication for fast response times. I added an OLED screen to my subsystem as well, to make debugging easier. A reset switch, connected to the engage pin on the ESP 32,ensures progamming is updated efficiently.
<br>
